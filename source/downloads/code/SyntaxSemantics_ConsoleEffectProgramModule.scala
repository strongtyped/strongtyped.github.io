object ConsoleEffectProgramModule {
  ...
  val consoleEffectProgramSyntaxWithNowSemanticsBndMain =
    nwExcCmpNowSemantics.safeExec(bndProgram[EffectSyntax].`~>semantics`)

  val consoleEffectProgramSyntaxWithNowSemanticsAndMain =
    nwExcCmpNowSemantics.safeExec(andProgram[EffectSyntax].`~>semantics`)
